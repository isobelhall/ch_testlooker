...
FROM opd.pops_data_replica as pops_data_replica
 ;;
  ...
  dimension: activity-plan {sql: JSON_UNQUOTE(JSON_EXTRACT(${properties},"$.activity-plan"));;}
  dimension: bmi {sql: JSON_UNQUOTE(JSON_EXTRACT(${properties},"$.bmi"));;}
  dimension: bmi-1 {sql: JSON_UNQUOTE(JSON_EXTRACT(${properties},"$.bmi-1"));;}
  dimension: choose-your-eating-plan-female {sql: JSON_UNQUOTE(JSON_EXTRACT(${properties},"$.choose-your-eating-plan-female"));;}
  dimension: choose-your-eating-plan-french {sql: JSON_UNQUOTE(JSON_EXTRACT(${properties},"$.choose-your-eating-plan-french"));;}
