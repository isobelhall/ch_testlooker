view: opt_data_flattened {
  ...
  dimension: healthy_living_diabetes_status_english {
    type: string
    label: "diabetes_status_english"
    case: {
      when: {
  ...
  dimension: healthy_living_disability_status_english {
    type: string
    label: "healthy_living_disability_status_english"
    case: {
      when: {
  ...
  dimension: healthy_living_ethnicity {
    type: string
    label: "healthy_living_ethnicity"
    case: {
      when: {
  ...
  dimension: healthy_living_gender_mfip {
    type: string
    label: "healthy_living_gender"
    case: {
      when: {
        sql: ${gender_m_f_i_p_healthy_living} = 0 ;;
        label: "Male"
      }
      when: {
        sql: ${gender_m_f_i_p_healthy_living} = 1 ;;
        label: "Female"
      }
      when: {
        sql: ${gender_m_f_i_p_healthy_living} = 2 ;;
        label: "Intersex"
      }
      when: {
        sql: ${gender_m_f_i_p_healthy_living} = 3 ;;
        label: "Prefer not to say"
      }
    }
  }
  dimension: language_healthy_living_updated {sql:JSON_UNQUOTE(JSON_EXTRACT(${hl_properties}, "$.language_healthy_living_updated"));;}
  dimension: healthy_living_first_language {
    type: string
    label: "healthy_living_first_language_english"
    case: {
      when: {
  ...
  dimension: healthy_living_smi_status_english {
    type: string
    label: "healthy_living_serious_mental_illness_status"
    case: {
      when: {
        sql: ${serious_mental_illness_status_healthy_living} = 1 ;;
        label: "Yes"
      }
      when: {
        sql: ${serious_mental_illness_status_healthy_living} = 2 ;;
        label: "No"
      }
      when: {
        sql: ${serious_mental_illness_status_healthy_living} = 3 ;;
        label: "Prefer not to say"
      }
    }
  }
  ...
  dimension: healthy_living_smoking_status_english {
    type: string
    label: "healthy_living_smoking_status_english"
    case: {
      when: {
