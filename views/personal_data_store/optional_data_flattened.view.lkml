view: optional_data_flattened {
  ...
  dimension: ethnicity_healthy_living_english {
    type: string
  ...
  dimension: gender_mfip_healthy_living_english {
    type: string
    label: "gender_mfip_healthy_living_english"
    case: {
      when: {
  ...
  dimension: language_healthy_living_english {
    type: string
  ...
  dimension: serious_mental_illness_status_healthy_living_english {
    type: string
    label: "serious_mental_illness_status_healthy_living_english"
    case: {
      when: {
  ...
  dimension: smoking_status_healthy_living_english  {
    type: string
    label: "smoking_status_healthy_living_english"
    case: {
      when: {
